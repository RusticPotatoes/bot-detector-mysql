...
-- DELIMITER $$
-- CREATE PROCEDURE InsertPlayerHiscoreDataLatestPlease()
-- BEGIN
-- 	-- DECLARE CONTINUE HANDLER FOR SQLEXCEPTION BEGIN END;
	
-- 	INSERT INTO playerHiscoreDataLatest (id, timestamp, ts_date, Player_id, total, attack, defence, strength, hitpoints, ranged, prayer) VALUES 
-- 	(1, NOW(), CURDATE(), 1, 1000, 70, 60, 80, 75, 65, 70),
-- 	(2, NOW(), CURDATE(), 2, 1200, 80, 70, 90, 85, 75, 80),
-- 	(3, NOW(), CURDATE(), 3, 800, 60, 50, 70, 65, 55, 60),
-- 	(4, NOW(), CURDATE(), 4, 1500, 90, 80, 100, 95, 85, 90),
...
-- CALL InsertPlayerHiscoreDataLatestPlease();
